"""Global FastAPI exception handlers for the dashboard.

Mirrors the SDA / FNOL handler shape. The dashboard has no upstream HTTP
calls in 7a, so there is no `httpx.RequestError` classification (that may
return in 7b when log-ingestion sources are wired up).
"""

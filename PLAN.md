...
| **PR 2** | Chaos middleware — each app gains a thin `X-Chaos: <directive>` middleware gated by `ENABLE_CHAOS=true` (default off). Enables cross-app cascade scenarios. **First real exercise of agentreviewer** per the policy. | ⬜ |
